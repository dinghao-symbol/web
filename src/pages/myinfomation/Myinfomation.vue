      ...
      <div>
        <form @submit.prevent="OnSendClick" >
          ...
          <div class="zi_box">
            ...
            <div class="zi_desc">
              <p>手机</p>
              <input v-validate="'required|phone'" name="mm_phone_number" v-model="newslist.mm_phone_number" class="zi_input" @input="handlePhone"/>
            </div>
          </div>
          <div class="zi_box">
            <p class="zi_star">*</p>
            <div class="zi_desc">
              <p>邮箱</p>
              <input v-validate="'required|email'" name="mm_email" v-model="newslist.mm_email" type="text" class="zi_input" />
            </div>
          </div>
          <div class="zi_box">
            <p class="zi_star">*</p>
            <div class="zi_desc">
              <p>地区</p>
              <van-field v-validate="'required'" readonly="readonly" @click="showPopup"  name="mm_city" type="text" class="zi_input_1" v-model="newslist.mm_city"/>
              <van-field v-validate="'required'" readonly="readonly" @click="showPopup"  name="mm_province" type="text" class="zi_input_1" v-model="newslist.mm_province"/>
        ...
        <div class="zi_xinxi">
          ...
          <!-- <div class="zi_box">
            ...
            <div class="zi_desc1">
              <p>入学时间</p>
              <input v-model="newslist.mm_entrance_date" type="text" class="zi_input" />
            </div>
          </div> -->
          <div class="zi_box">
            <p class="zi_star"></p>
            <div class="zi_desc1">
              <p>入学时间</p>
              <van-field  readonly="readonly" @click="showPopuptime"  type="text" class="zi_input_2" v-model="newslist.mm_entrance_date"/>
